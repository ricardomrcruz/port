          ...
          <section className='min-h-screen'>
            <nav className='py-10 mb-10 flex justify-between'>
              ...
              <ul className='flex items-center'>
                ...
                <li><Link href="/fr">
                  <p className='bg-gradient-to-r from-cyan-600 to-teal-500 dark:from-purple-600 dark:to-blue-400 text-white px-6 py-2 rounded-md ml-8'>FR</p></Link>
                </li>
              </ul>
            </nav>
            <div className='text-center p-10'>
              ...
              <h3 className='text-2xl py-2 md:text-1xl dark:text-gray-100 font-mono'>Fullstack Web Developer & Designer</h3>
              <h4 className='text-xl py-2 md:text-xl dark:text-gray-200 font-mono'>Based in Strasbourg, France.</h4>
              <br />
              <p className='text-md leading-6 text-gray-800 md:text-xl max-w-lg mx-auto dark:text-gray-300 font-mono tracking-tight  '>
                Proficient in website and database design, conception, and deployment. 
                <br /> Experienced in developing CMS and eCommerce platforms with a focus on SEO performance. 
                <br /> Offering top-notch digital solutions for your online business. 
