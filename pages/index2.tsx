      ...
      <section className="relative ">
        <div className="min-h-screen flex flex-col justify-between">
          ...
          <nav className="z-10 relative py-10 mb-12 flex justify-between px-10 md:px-20 lg:px-20">
            <p className="text-2xl md:text-3xl font-mono dark:text-white ">
              @ricardomartinho__
            </p>
          ...
          >
            <h1
              className="text-[47px]  py-2 font-roboto font-semibold  dark:text-white inline-block align-middle md:text-[68px] lg:text-[68px] "
              style={{ lineHeight: "1.02" }}
            >
              FullStack <br />
              Web Developer <br />
              UX UI Web and <br /> Graphic Designer
            </h1>
          </div>
          <div
          ...
          <div className="z-10 relative py-5 mb-12 flex justify-between px-10 md:px-20 lg:px-20">
            <h1 className="text-2xl md:text-2xl font-roboto dark:text-white ">
